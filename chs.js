...
var cnItems = {
    ...
    "Electrum tree": "金银花",
    "Ethereal field and ethereal crops": "飘渺的田野和飘渺的庄稼",
    ...
    "on mobile/touch devices, you can long-press most icons/buttons to access the shift and ctrl variants (e.g. the pause button and refresh watercress button).": "在移动/触摸设备上，您可以长按大多数图标/按钮来访问 Shift 和 Ctrl 变体（例如暂停按钮和刷新豆瓣菜按钮）。",
    "replace crop.": "更换作物。",
    "similar to p, but always plants, so replaces crop if there is an existing one below the mouse cursor.": "与 p 类似，但总是植物，因此如果鼠标光标下方存在现有作物，则替换作物。",
    "undo / redo": "撤销重做",
